...
namespace Payment.Gateway.Api.UnitTests.Validation
{
    public class PaymentRequestValidatorTests
    {
        ...
        public void Validate_ForVariousPaymentIds_ShouldValidateAsExpected(string paymentId, bool expectedResult)
        {
